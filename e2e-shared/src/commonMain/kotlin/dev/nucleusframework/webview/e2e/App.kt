...
import dev.nucleusframework.webview.util.KLogSeverity
...
fun App() {
    BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
        ...
        var cookieName by remember { mutableStateOf("e2e_cookie") }
        ...
        var jsSnippet by remember {
            mutableStateOf(
                ...
                """
                (function () {
                  const id = "composewebview-e2e-banner";
                            ...
                            AnimatedVisibility(visible = toolsVisible) {
                                ToolsPanel(
                                    ...
                                    onSetCookie = {
                                        ...
                                        val cookie = Cookie(
                                            name = cookieName.trim().ifBlank { "e2e_cookie" },
                                            value = cookieValue,
                                            domain = domain,
                                            path = path,
                                            isSessionOnly = true,
